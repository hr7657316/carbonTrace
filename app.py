...
translations = {
    'English': {
        ...
        'welcome_message': 'Welcome to CarbonTrace! Start by adding your emissions data or uploading a CSV file.',
    ...
    'Hindi': {
        ...
        'welcome_message': 'CarbonTrace में आपका स्वागत है! अपना उत्सर्जन डेटा जोड़कर या CSV फ़ाइल अपलोड करके प्रारंभ करें।',
...
with st.sidebar:
    ...
    # Footer
    st.markdown(
        "<div class='footer' style='color: #555555;'> 2025 CarbonTrace<br>Product Owner: Sonu Kumar<br>sonu@aianytime.net</div>",
        unsafe_allow_html=True
    )
...
if st.session_state.active_page == "Dashboard":
    ...
    if len(st.session_state.emissions_data) == 0:
        st.markdown(f"<div class='info-box' style='color: green;'>{t('welcome_message')}</div>", unsafe_allow_html=True)
    else:
        # Calculate metrics
